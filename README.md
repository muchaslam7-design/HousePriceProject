...
* **Backend API:** C# ASP.NET Core Web API, Entity Framework Core, JWT Authentication
* **Machine Learning Microservice:** Python, Flask, Scikit-Learn / TensorFlow
* **Database & Tools:** SQL Server Management Studio (SSMS) / MySQL, Swagger UI, Postman
